...
4. 在File View（左下角）中：
1)选择Header File，右键-Add files to folder，选resource.h；
2)选择Source Files，右键-Add files to folder，选09-01client.c；
3)选择Resource Files，右键-Add files to folder，选09-01client.rc
